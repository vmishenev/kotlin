...
@FirBuilderDsl
class FirWhileLoopBuilder : FirLoopBuilder, FirAnnotationContainerBuilder, FirExpressionBuilder {
    ...
    @Deprecated("Modification of 'typeRef' has no impact for FirWhileLoopBuilder", level = DeprecationLevel.HIDDEN)
