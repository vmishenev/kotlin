...
@FirBuilderDsl
class FirErrorLoopBuilder : FirAnnotationContainerBuilder, FirExpressionBuilder {
    ...
    @Deprecated("Modification of 'typeRef' has no impact for FirErrorLoopBuilder", level = DeprecationLevel.HIDDEN)
